...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">VESIT SETU ONLINE PORTAL</a>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/hero-11.jpg);">
...
<script>document.write(new Date().getFullYear());</script> VESIT SETU MANAGEMENT SYSYEM
